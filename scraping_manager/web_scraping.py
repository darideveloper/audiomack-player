# >>> NEW VERSION OF MY MODULE (A LOT OF CHANGES, COMPARA BY YOURSELF WITH YOUR OWN VERSION)
import os
import time
import zipfile
...
class WebScraping ():
    ...
    def __set_browser_instance__(self):
        ...
        # >>> ONE OF THE MAIN CHANGES: WEB DRIVER MANAGENER DOWNLOADED AND INSTALLED WITH SELENIUM INSTEAD OF WEB DRIVER MANAGE
        # >>> NO WEB DRIVER MANAGER LONGER REQUIRED
